...
printf 'Pip install download requirements.txt from Medical-SAM3 repo:\n'
printf 'cd external/Medical-SAM3 && pip install -r requirements.txt\n'
printf 'cd back to workspace directory: cd ../../\n'
